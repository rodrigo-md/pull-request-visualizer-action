  ...
  return hydrateRuntimeState({
    ...
    "dependencyTreeRoots": [
      ...
      },
      {
        ...
        "reference": "workspace:packages/coverage-report"
      },
      {
        "name": "generate-site",
        "reference": "workspace:packages/generate-site"
      },
      {
        "name": "git-diff",
        "reference": "workspace:packages/git-diff"
      },
      {
        "name": "notify-deployment",
        "reference": "workspace:packages/notify-deployment"
      }
    ],
    "enableTopLevelFallback": true,
    "ignorePatternData": "(^(?:\\.yarn\\/sdks(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$)",
    "fallbackExclusionList": [
      ["coverage-report", ["workspace:packages/coverage-report"]],
      ["generate-site", ["workspace:packages/generate-site"]],
      ["git-diff", ["workspace:packages/git-diff"]],
      ["notify-deployment", ["workspace:packages/notify-deployment"]],
      ["pull-request-visualizer-action", ["workspace:."]]
    ],
    "fallbackPool": [
    ],
    "packageRegistryData": [
      ...
      ["@actions/artifact", [
        ["npm:0.6.1", {
          "packageLocation": "./.yarn/cache/@actions-artifact-npm-0.6.1-77dd27666f-1f84defd11.zip/node_modules/@actions/artifact/",
          "packageDependencies": [
            ["@actions/artifact", "npm:0.6.1"],
      ...
      ["@vercel/ncc", [
        ["npm:0.33.3", {
          "packageLocation": "./.yarn/cache/@vercel-ncc-npm-0.33.3-3698cb4050-0dd73aae0d.zip/node_modules/@vercel/ncc/",
          "packageDependencies": [
            ["@vercel/ncc", "npm:0.33.3"],
            ["node-gyp", "npm:8.4.1"]
          ],
      ...
      ["coverage-report", [
        ["workspace:packages/coverage-report", {
          "packageLocation": "./packages/coverage-report/",
          "packageDependencies": [
            ["coverage-report", "workspace:packages/coverage-report"],
            ["@actions/artifact", "npm:0.6.1"],
            ["@actions/core", "npm:1.6.0"],
      ...
      ["generate-site", [
        ["workspace:packages/generate-site", {
          "packageLocation": "./packages/generate-site/",
          "packageDependencies": [
            ["generate-site", "workspace:packages/generate-site"],
            ["@actions/core", "npm:1.6.0"],
            ["@vercel/ncc", "npm:0.33.3"]
      ...
      ["git-diff", [
        ["workspace:packages/git-diff", {
          "packageLocation": "./packages/git-diff/",
          "packageDependencies": [
            ["git-diff", "workspace:packages/git-diff"],
            ["@actions/core", "npm:1.6.0"],
            ["@vercel/ncc", "npm:0.33.3"]
      ...
      ["notify-deployment", [
        ["workspace:packages/notify-deployment", {
          "packageLocation": "./packages/notify-deployment/",
          "packageDependencies": [
            ["notify-deployment", "workspace:packages/notify-deployment"],
            ["@actions/core", "npm:1.6.0"],
            ["@actions/github", "npm:5.0.0"],
      ...
      ["pull-request-visualizer-action", [
        ["workspace:.", {
          "packageLocation": "./",
          "packageDependencies": [
            ["pull-request-visualizer-action", "workspace:."],
