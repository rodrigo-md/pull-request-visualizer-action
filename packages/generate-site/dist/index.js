...
const oidc_utils_1 = __nccwpck_require__(218);
/**
...
const auth_1 = __nccwpck_require__(911);
const core_1 = __nccwpck_require__(941);
class OidcClient {
...
const pm = __nccwpck_require__(672);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(428);
            }
            const agentOptions = {
...
const { generateSite, wait, generateToml } = __nccwpck_require__(931);
